...
<head>
  ...
  {{-- gunakan @yield lalu diisi title untuk dipanggil di dashboard dengan section --}}
...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          {{-- penggunaan auth user harus dengan {{ lalu masukan auth user -> email/name bebas}} --}}
        </div>
      </div>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/services" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  {{-- untuk memastikan link yg akan digunakan url --}}
                  <p>Data Services</p>
                </a>
              </li>
              <li class="nav-item">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                @yield('content')
                {{-- semua yg isinya yiel content diatur dari dashboard --}}
              </div>
            </div>
          </div>
          <!-- /.col-md-6 -->
  ...
  <footer class="main-footer">
    ...
    {{-- {{ date ('Y')}} untuk membuat tahun sekarang --}}
  </footer>
</div>
<!-- ./wrapper -->
